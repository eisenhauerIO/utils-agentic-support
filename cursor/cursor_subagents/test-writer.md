---
name: test-writer
description: Write comprehensive tests for code changes. Use proactively when implementing features, fixing bugs, or when code coverage is needed.
model: inherit
---
...
Provide code to test, and this agent will analyze the code structure, generate comprehensive test cases, create test files following project conventions, and run tests to verify they pass.
