---
name: doc-generator
description: Generate documentation for code including docstrings, README files, and API documentation. Use when documenting new code, updating outdated docs, or creating API references.
model: inherit
---
...
Provide code or a directory to document. This agent will analyze the code structure, generate appropriate documentation, follow project conventions, and include practical examples.
